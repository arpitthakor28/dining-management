    ...
    return (<div className="dark-theme-wrapper p-6">
      ...
      <div className="max-w-[1200px] mx-auto z-10 relative">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div>
            <button onClick={() => navigate('/counter')} className="flex items-center gap-1 text-green-400 hover:underline font-bold text-sm mb-2">
          ...
          <div className="glass-card rounded-xl border border-white/10 p-6 h-fit" onMouseMove={handleMouseMove}>
            ...
            <form onSubmit={handleAddTable} className="space-y-4 z-10 relative">
              <div>
                ...
                <input type="text" placeholder="e.g. 6 or 14" value={newTableNum} onChange={(e) => setNewTableNum(e.target.value)} className="input-dark w-full rounded-lg py-2.5 px-4 font-bold text-sm" required/>
              </div>
            ...
            return (<div key={table.id} className="p-4 flex flex-col md:flex-row items-center gap-4 hover:bg-white/5 transition-colors">
                      ...
                      <div className="flex-1 text-center md:text-left min-w-0">
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 mb-1.5">
                          ...
                          <span className={`text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase ${table.status === 'bill_requested' ? 'bg-orange-500/20 text-orange-350 border border-orange-500/30' :
