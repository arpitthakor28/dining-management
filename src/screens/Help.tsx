...
export default function Help() {
  ...
  return (
    <div className="pb-36 pt-6 px-5 bg-white min-h-screen">
      ...
      <div className="bg-green-50 rounded-2xl border border-green-100 p-5 mb-8 text-center shadow-sm">
        ...
        <button
          ...
          className="bg-primary hover:bg-primary-dark text-white font-bold py-2 px-6 rounded-lg text-sm transition-all shadow-md active:scale-95"
        >
          Call Waiter
        </button>
      </div>
