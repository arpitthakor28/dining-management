...
export default function KitchenDashboard() {
  ...
  const activeBatches = batches.filter(batch => 
    batch.items.some(item => item.status !== 'served')
  );

  const getMinutesAgo = (timestamp: Date) => {
        ...
        <div className="flex justify-between items-center mb-8 bg-white/5 backdrop-blur-md p-6 rounded-2xl border border-white/10 shadow-lg">
          ...
          <div className="flex items-center gap-4">
             <button 
               ...
               className="flex items-center gap-1.5 px-4 py-2 btn-premium-danger text-sm rounded-lg transition"
             >
                            ...
                            <div className="flex gap-1.5 mt-1">
                              ...
                              {item.status === 'preparing' && (
                                <button
                                  ...
                                  className="flex-1 btn-premium-orange py-1.5 px-2 text-xs rounded-lg transition-all flex items-center justify-center gap-1 active:scale-95"
                                >
                                  <Check size={12} /> Ready
                                </button>
                              )}
